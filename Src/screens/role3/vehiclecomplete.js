...
const Vehiclecomplete = props => {
  ...
  const Vehiclechoseapi = async () => {
    ...
    axios
      .get(BASE_URL + 'get-vehicalcompleted', {
        headers: {
      ...
      .then(res => {
        console.log('vehicle complete ====>', res.data.data);
  ...
  const vehicleusedapi = async () => {
    if (endingkm === '' || endingkm === null) {
      Toast.show('Please enter a ending km');
    } else if (imguri === '' || imguri === null) {
      Toast.show('Please Select Km Photo');
    } else {
      setload1(true);
      var Token = await AsyncStorage.getItem('token');
      ...
      formdata.append('ending_km', endingkm);
      var img = {uri: imguri, name: fileName, type: type};
      formdata.append('kmphoto', img);
      console.log('formdata --->', formdata);
      axios
        .post(BASE_URL + 'vehical-completed', formdata, {
          headers: {
            Accept: ACCEPT_HEADER,
            Authorization: 'Bearer ' + Token,
          },
    ...
    <View style={{flex: 1, backgroundColor: colors.white}}>
        ...
        {vehicledata == 0 ? (
          <View
            ...
            <Image
              ...
              style={{width: metrics.WIDTH * 0.5, height: metrics.HEIGHT * 0.3}}
              resizeMode="stretch"
            />
          </View>
        ) : (
              ...
              return (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    item.id == 3 ? setismodel(true) : null;
                  }}
                  style={{padding: '3%'}}>
                  <Text
                    style={{
      ...
      <RNModal
        ...
        <View
          ...
          <Text style={{color: colors.black, fontSize: 16}}>Ending Km :</Text>
          <View
            style={{
              width: '90%',
              backgroundColor: colors.white,
...
export default Vehiclecomplete;
